...
const Bookings = () => {
  ...
  const url = `https://car-doctor-server-gamma-sandy-71.vercel.app/checkout?email=${user?.email}`
  ...
  const handleDelete = id =>{
    ...
    if(proceed){
        ...
        fetch(`https://car-doctor-server-gamma-sandy-71.vercel.app/bookings/${id}`,{
            method : 'DELETE'
        })
        .then(res=>res.json())
        .then(data=>{
